# -*- coding: utf-8 -*-
#
# pylibfreenect2 documentation build configuration file, created by
...
htmlhelp_basename = 'pypylibfreenect2doc'
...
latex_documents = [
    (master_doc, 'pylibfreenect2.tex', u'pylibfreenect2 Documentation',
...
man_pages = [
    (master_doc, 'pylibfreenect2', u'pylibfreenect2 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pylibfreenect2', u'pylibfreenect2 Documentation',
     author, 'pylibfreenect2', 'One line description of project.',
     'Miscellaneous'),
]
